...
function showCard() {
    ...
    setTimeout(() => {
        alert("Дорогой друг,Карты сложились удачно, звёзды шепчут твое имя, а ветер перемен несёт тебя в одно особенное место…🔮✨. Ателье магических колпаков ждёт тебя! Здесь твоя судьба обретёт новый облик, а твой идеальный колпак — уже готова раскрыть свой секрет. Сделай шаг навстречу чуду!");
    }, 1500);
}
